![@saurabharch/json-rules-engine](http://i.imgur.com/MAzq7l2.png)
[![js-standard-style](https://cdn.rawgit.com/feross/standard/master/badge.svg)](https://github.com/feross/standard)
[![Build Status](https://github.com/saurabharch/json-rules-engine/workflows/Node.js%20CI/badge.svg?branch=master)](https://github.com/saurabharch/json-rules-engine/workflows/Node.js%20CI/badge.svg?branch=master)
...
```bash
$ npm install @saurabharch/json-rules-engine
```
...
```js
const { Engine } = require('@saurabharch/json-rules-engine')
